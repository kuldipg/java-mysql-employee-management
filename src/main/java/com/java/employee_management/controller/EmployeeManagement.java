package com.java.employee_management.controller;
...
import com.java.employee_management.repository.ComplianceRepository;
import com.java.employee_management.repository.DepartmentRepository;
import com.java.employee_management.repository.EmployeeRepository;
import com.java.employee_management.repository.StatusReportRepository;
...
public class EmployeeManagement extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("EmployeeManagement >  do Get");
        try {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("EmployeeManagement >  do Post");
        try {
            requestHelper(request, response);
        } catch (SQLException e) {
    ...
    public void requestHelper(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        if (param == null) {
            ...
            if (param != null && param.equals("save") && cancelParm == null) {
                ...
                user.setDeptid(parseInt(request.getParameter("deptid")));
            ...
            if (param != null && param.equals("edit_dept")) {
                ...
                Integer deptId = parseInt(request.getParameter("id"));
            ...
            if (param != null && param.equals("delete_dept")) {
                ...
                if (deptIdToDelete != null) {
                    deptRepo = new DepartmentRepository();
                    deptRepo.deleteDepartment(parseInt(deptIdToDelete));
                }
                doBeforeReturnToDashBoard(request, response);
                RequestDispatcher dispatcherAddUser = request.getRequestDispatcher(forward);
                dispatcherAddUser.forward(request, response);
            ...
            if (param != null && param.equals("edit_comp")) {
                ...
                Integer compId = parseInt(request.getParameter("id"));
            ...
            if (param != null && param.equals("delete_comp")) {
                ...
                if (compIdToDelete != null) {
                    compRepo = new ComplianceRepository();
                    compRepo.deleteCompliance(parseInt(compIdToDelete));
                }
                doBeforeReturnToDashBoard(request, response);
                RequestDispatcher dispatcherAddUser = request.getRequestDispatcher(forward);
                dispatcherAddUser.forward(request, response);
            ...
            if (param != null && param.equals("save_comp") && cancelParm == null) {
                ...
                comp.setDepartmentId(parseInt(request.getParameter("deptid")));
                String id = request.getParameter("id");
                if (id == null || id.isEmpty()) {
                    //save
                    saveCompliance(comp);
            ...
            if (param != null && param.equals("edit_comment")) {
                ...
                Integer srtrptId = parseInt(request.getParameter("id"));
            ...
            if (param != null && param.equals("save_comment") && cancelParm == null) {
                ...
                stsrpt.setCompId(parseInt(request.getParameter("compId")));
                ...
                stsrpt.setDeptId(loggedInUser.getDeptid());
            ...
            if (param != null && param.equals("dashboard")) {
                forward = DASHBOARD;
                doBeforeReturnToDashBoard(request, response);
                RequestDispatcher dispatcherAddUser = request.getRequestDispatcher(forward);
                dispatcherAddUser.forward(request, response);
